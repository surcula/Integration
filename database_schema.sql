...
CREATE TABLE roles_authorization (
    ...
    CONSTRAINT fk_roles_authorization_role
        FOREIGN KEY (role_id) REFERENCES roles(role_id),
    CONSTRAINT fk_roles_authorization_authorization
        FOREIGN KEY (authorization_id) REFERENCES authorizations(authorization_id),
    CONSTRAINT uq_roles_authorization UNIQUE (role_id, authorization_id)
) ENGINE=InnoDB;
...
CREATE TABLE departments (
    ...
    CONSTRAINT fk_departments_head_employee
...
CREATE TABLE department_heads (
    ...
    CONSTRAINT fk_department_heads_superior
...
CREATE TABLE employee_superiors (
    ...
    superior_id INT NOT NULL,
    employee_id INT NOT NULL,
    CONSTRAINT fk_employee_superiors_superior
        FOREIGN KEY (superior_id) REFERENCES employees(employee_id),
    CONSTRAINT fk_employee_superiors_employee
        FOREIGN KEY (employee_id) REFERENCES employees(employee_id)
) ENGINE=InnoDB;
...
CREATE TABLE employees_functions (
    ...
    employee_id INT NOT NULL,
    CONSTRAINT fk_employees_functions_function
        FOREIGN KEY (function_id) REFERENCES functions(function_id),
    CONSTRAINT fk_employees_functions_employee
        FOREIGN KEY (employee_id) REFERENCES employees(employee_id)
) ENGINE=InnoDB;
...
CREATE TABLE plannings (
    ...
    employee_id INT,
    department_id INT,
    CONSTRAINT fk_plannings_employee
        FOREIGN KEY (employee_id) REFERENCES employees(employee_id),
    CONSTRAINT fk_plannings_department
        FOREIGN KEY (department_id) REFERENCES departments(department_id)
) ENGINE=InnoDB;
...
CREATE TABLE planning_employees (
    ...
    CONSTRAINT fk_planning_employees_employee
        FOREIGN KEY (employee_id) REFERENCES employees(employee_id),
    CONSTRAINT fk_planning_employees_planning
...
CREATE TABLE training_centers (
    ...
    is_active BOOLEAN NOT NULL DEFAULT TRUE,
    address_id INT,
    CONSTRAINT fk_training_centers_address
        FOREIGN KEY (address_id) REFERENCES addresses(address_id)
) ENGINE=InnoDB;
...
CREATE TABLE training_functions (
    ...
    function_id INT NOT NULL,
    CONSTRAINT fk_training_functions_training
        FOREIGN KEY (training_id) REFERENCES trainings(training_id),
    CONSTRAINT fk_training_functions_function
        FOREIGN KEY (function_id) REFERENCES functions(function_id),
    CONSTRAINT uq_training_functions UNIQUE (training_id, function_id)
) ENGINE=InnoDB;
...
CREATE TABLE employees_certificates (
    ...
    CONSTRAINT fk_employees_certificates_training
        FOREIGN KEY (training_id) REFERENCES trainings(training_id),
    CONSTRAINT fk_employees_certificates_employee
        FOREIGN KEY (employee_id) REFERENCES employees(employee_id),
    CONSTRAINT fk_employees_certificates_training_center
        FOREIGN KEY (training_center_id) REFERENCES training_centers(training_center_id)
) ENGINE=InnoDB;
...
CREATE TABLE criteria_functions (
    ...
    CONSTRAINT fk_criteria_functions_function
        FOREIGN KEY (function_id) REFERENCES functions(function_id),
    CONSTRAINT fk_criteria_functions_criteria
        FOREIGN KEY (criteria_id) REFERENCES criteria(criteria_id),
    CONSTRAINT uq_criteria_functions UNIQUE (function_id, criteria_id)
) ENGINE=InnoDB;
...
CREATE TABLE evaluations (
    ...
    comment VARCHAR(255),
    global_score_set BOOLEAN NOT NULL DEFAULT FALSE,
    evaluator_id INT,
    employee_id INT NOT NULL,
...
CREATE TABLE evaluation_criteria (
    ...
    criteria_id INT NOT NULL,
    CONSTRAINT fk_evaluation_criteria_evaluation
        FOREIGN KEY (evaluation_id) REFERENCES evaluations(evaluation_id),
    CONSTRAINT fk_evaluation_criteria_criteria
        FOREIGN KEY (criteria_id) REFERENCES criteria(criteria_id)
) ENGINE=InnoDB;
...
CREATE TABLE evaluation_objectives (
    ...
    evaluation_id INT NOT NULL,
    CONSTRAINT fk_evaluation_objectives_objective
        FOREIGN KEY (objective_id) REFERENCES objectives(objective_id),
    CONSTRAINT fk_evaluation_objectives_evaluation
        FOREIGN KEY (evaluation_id) REFERENCES evaluations(evaluation_id)
) ENGINE=InnoDB;
...
CREATE TABLE job_offers (
    ...
    function_id INT,
    city_id INT,
    CONSTRAINT fk_job_offers_function
        FOREIGN KEY (function_id) REFERENCES functions(function_id),
    CONSTRAINT fk_job_offers_city
        FOREIGN KEY (city_id) REFERENCES cities(city_id)
) ENGINE=InnoDB;
...
CREATE TABLE job_offers_candidates (
    ...
    CONSTRAINT fk_job_offers_candidates_job_offer
        FOREIGN KEY (job_offer_id) REFERENCES job_offers(job_offer_id),
    CONSTRAINT fk_job_offers_candidates_candidate
...
('EVALUATION_WRITE', TRUE),
('TRAINING_READ', TRUE),
('TRAINING_WRITE', TRUE);

INSERT INTO functions (function_name, description, is_active) VALUES
('Infirmier', 'Fonction medicale', TRUE),
('Medecin', 'Fonction medicale', TRUE),
('Responsable RH', 'Gestion des ressources humaines', TRUE),
('Manager', 'Responsable d equipe', TRUE);
